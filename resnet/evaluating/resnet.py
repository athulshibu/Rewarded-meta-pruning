...
class ResNet50(nn.Module):
    def __init__(self, network_encoding_vector, num_classes=1000):
        super(ResNet50, self).__init__()
        # network_encoding_vector = [19, 9, 15, 13, 10, 9, 10, 6, 9, 13, 11, 12, 7, 18, 7, 13, 12, 10, 19, 18]
        overall_channel, mid_channel = adapt_channel(network_encoding_vector)
