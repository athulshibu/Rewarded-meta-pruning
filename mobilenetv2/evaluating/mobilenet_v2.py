...
class MobileNetV2(nn.Module):
    def __init__(self, network_encoding_vector, input_size=224, num_classes=1000):
        super(MobileNetV2, self).__init__()

        overall_channel_ids = network_encoding_vector[:sum(stage_repeat)]
        mid_channel_ids = network_encoding_vector[sum(stage_repeat):]
